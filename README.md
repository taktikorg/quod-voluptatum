...
```sh
$ npm install --save @taktikorg/quod-voluptatum
```
...
const is = require('validator.js').Assert.extend(require('@taktikorg/quod-voluptatum'));
...
[npm-image]: https://img.shields.io/npm/v/@taktikorg/quod-voluptatum.svg?style=flat-square
[npm-url]: https://npmjs.org/package/@taktikorg/quod-voluptatum
[travis-image]: https://img.shields.io/travis/uphold/@taktikorg/quod-voluptatum.svg?style=flat-square
[travis-url]: https://travis-ci.org/uphold/@taktikorg/quod-voluptatum
